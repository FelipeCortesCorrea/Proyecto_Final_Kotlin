...
import com.example.proyectodashboard.components.Huevos
...
fun Page_Huevos(){
    ...
    items(listaProductosHuevos){ producto ->
        ProductCardHuevos(producto = producto)
    }
}
}
val listaProductosHuevos = listOf(
    Huevos.Huevos01,
    Huevos.Huevos02,
    Huevos.Huevos03,
...
@Composable
private fun ProductCardHuevos(producto: Huevos){
