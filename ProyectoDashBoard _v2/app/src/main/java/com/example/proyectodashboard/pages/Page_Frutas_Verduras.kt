...
fun Page_Frutas_Verduras(){
    LazyVerticalGrid(
        ...
        items(listaProductosFrutas_Verduras){ producto ->
            ProductCardFrutas(producto = producto)
        }
    }
}
val listaProductosFrutas_Verduras = listOf(
    Frutas_Verduras.Fruta01,
    Frutas_Verduras.Fruta02,
    Frutas_Verduras.Fruta03,
    Frutas_Verduras.Fruta04,
    Frutas_Verduras.Fruta05,
    Frutas_Verduras.Fruta06,

    )

@OptIn(ExperimentalMaterialApi::class)
@Composable
private fun ProductCardFrutas(
    producto: Frutas_Verduras,
){
