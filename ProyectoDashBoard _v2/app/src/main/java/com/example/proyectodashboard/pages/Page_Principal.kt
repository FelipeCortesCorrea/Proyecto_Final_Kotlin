...
import com.example.proyectodashboard.components.Principal
...
fun  Page_Principal(){
    LazyVerticalGrid(
        ...
        items(listaProductosPrincipal){ producto ->
            ProductCardPrincipal(producto = producto)
        }
    }
}
val listaProductosPrincipal = listOf(
    Principal.producto01,
    Principal.producto02,
    Principal.producto03,
    Principal.producto04,
    Principal.producto05,
    Principal.producto06,
    Principal.producto07,
    Principal.producto08,
    Principal.producto09,
    Principal.producto10,

    )

@OptIn(ExperimentalMaterialApi::class)
@Composable
private fun ProductCardPrincipal(producto: Principal){
